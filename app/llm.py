...
Если в данных есть поле page_price, используй его как цену для поста. Пиши цену как «от: 3 671 ₽» и обязательно добавляй фразу «Цена может отличаться, проверяйте у себя!».
