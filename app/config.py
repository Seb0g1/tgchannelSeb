...
class Settings(BaseSettings):
    ...
    max_products_per_sync: int = Field(30000, alias="MAX_PRODUCTS_PER_SYNC")
    ...
    ozon_visibility: str = Field("ALL", alias="OZON_VISIBILITY")
    ...
    openrouter_site_name: str = Field("Aromat Day", alias="OPENROUTER_SITE_NAME")
